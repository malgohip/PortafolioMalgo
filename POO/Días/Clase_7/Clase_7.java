...
//import java.math.*;    
    class PuntoD{
    public int x,y;
    public PuntoD(){/*x=0;y=0;*/this(0,0);}
    public PuntoD(int x1, int y1){x=x1;   y=y1;}
    public PuntoD(PuntoD p){/*x=p.x;  y=p.y;*/this(p.x,p.y);}
    ...
    public double Distancia(){ /*Distancia al origenreturn Math.sqrt(x*x+y*y);*/ return Distancia(new PuntoD());}
    }
