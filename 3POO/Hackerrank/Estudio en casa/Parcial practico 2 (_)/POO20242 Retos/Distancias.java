...
public class Distancias{
    public static void main(String[] args){
        Scanner sc = new Scanner(System.in); int n=sc.nextInt(); Punto[] punto = new Punto[n];
        for (int i=0;i<n;i++){ int x=sc.nextInt(), y=sc.nextInt(); punto[i]=new Punto(x,y);}
        sc.close();
        Punto a = punto[0]; Punto b = punto[1]; double distanciaMin = a.Distancia(b);
