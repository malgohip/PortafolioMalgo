...
while respuesta=='s':
    ...
    ar=area(N,radio)
    print(f"Para el n-ágono regular con radio {radio} y {N} numero de lados, su perimetro es: {round(perime,3)}u (aproximadamente) y su area es {round(ar,3)}u² (aproximadamente).")
