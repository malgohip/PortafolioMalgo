...
"""
"""
a = open('Ejercicios Code Abey\TXTs\e58 Card Names.txt','r')
P= a.readlines()
...
print(cartas)
"""
cartas=[45, 40, 28, 30, 34, 6, 44, 13, 23, 17, 12, 22, 25, 11, 35, 24, 21, 7, 33, 10, 16, 50, 9]

manos = ['Clubs', 'Spades', 'Diamonds', 'Hearts']
...
for x in cartas:
    valor_mano=x//13
    numero_valor=x%13
    respuesta+=valor[numero_valor]+'-of-'+manos[valor_mano]+' '
print(respuesta)